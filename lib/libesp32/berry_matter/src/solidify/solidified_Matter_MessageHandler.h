...
be_local_closure(class_Matter_MessageHandler_msg_received,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[356]) {  /* code */
      ...
      0x8C281537,  //  0130  GETMET	R10	R10	K55
      ...
      0x8C28013F,  //  013A  GETMET	R10	R0	K63
      ...
      0x58300031,  //  0145  LDCONST	R12	K49
